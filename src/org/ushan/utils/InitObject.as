package away3d.core.utils
{
    ...
    public class InitObject
    {
        ...
        public function InitObject(init:Object)
        {
            this.init = init;
        }

        public static function parse(init:Object):InitObject
        {
            if (init == null)
                return new InitObject(null);
            if (init is InitObject)
                return init as InitObject;

            inits.push(init);
            return new InitObject(init);
        }
        ...
        public function getInit(name:String):InitObject
        {
            if (init == null)
                return new InitObject(null);
            ...
            var result:InitObject = InitObject.parse(init[name]);
